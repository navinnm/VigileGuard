...
```bash
# Build image
docker build -t vigileguard:v3.0.2 .

# Run container
docker run -p 8000:8000 vigileguard:v3.0.2
```
...
tar -czf vigileguard-phase3-v3.0.2.tar.gz $DEPLOY_DIR/

echo "✅ Deployment package created:"
echo "   📁 Directory: $DEPLOY_DIR/"
echo "   📦 Archive: vigileguard-phase3-v3.0.2.tar.gz"
echo ""
echo "🚀 To deploy:"
echo "   1. Copy vigileguard-phase3-v3.0.2.tar.gz to your server"
echo "   2. Extract: tar -xzf vigileguard-phase3-v3.0.2.tar.gz"
